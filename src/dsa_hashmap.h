...
#undef NDEBUG
#include "dsa_darray.h"
#include "utils_dbg.h"
#include "utils_bstrlib.h"
#include <stdint.h>
...
static uint32_t default_hash(void *);
static HashmapNode *Hashmap_node_create(int, void *, void *);
static DArray *Hashmap_find_bucket(Hashmap *, void *, int, uint32_t *);
static int Hashmap_get_node(Hashmap *, uint32_t, DArray *, void *);
...
int Hashmap_traverse(Hashmap *, Hashmap_traverse_cb);
...
static HashmapNode *Hashmap_node_create(int hash, void *key, void *data) {
...
static DArray *Hashmap_find_bucket(
  Hashmap *map,
  void *key,
  int create,
  uint32_t *hash_out
...
void *Hashmap_delete(Hashmap *map, void *key) {
  ...
  if (ending != node) {
    // since it's not the last one, swap it
